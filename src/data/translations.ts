...
const el: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'Είμαστε εδώ καθημερινά — για το πρωινό μπάνιο, το μεσημεριανό, τον απογευματινό παγωμένο καφέ. Πάρε τον χρόνο σου. Βρες μια θέση στον ήλιο. Καλώς ήρθες στο happy place μέρος σου.'
    ],
    pullQuote: 'Powered by coffee, driven by joy.',
    pullQuoteAttribution: '— the dickies',
  ...
  contact: {
    ...
    closingCtaTitle: 'Όχι απλώς καφές — το happy place σου.',
